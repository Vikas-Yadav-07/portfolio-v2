  ...
  return (
    <section className="z-10 flex w-full flex-col items-center justify-center overflow-hidden bg-[#0E1016] bg-cover bg-center pt-20 md:pb-16 lg:pb-32">
      ...
      <div className="container p-4">
        <ol
          className="relative flex flex-col item-center justify-center   border-l border-gray-200 dark:border-gray-700">
          {timelineDetails.map((timeline, i) => {
            return <TimelineTile key={i} title={timeline.title} description={timeline.description} date={timeline.date} />
          })}
        </ol>
      </div>
    </section>
